...
TapDangThuc = FiniteSet(dt2, dt3, dt4, dt5, dt6, dt7, dt8, dt9, dt10, dt11, dt12, dt13, dt14, dt15, dt16, dt17,
...
GiaThuyet = FiniteSet((a, 2), (b, 1), (A, pi / 2))

# kết luận
KetLuan = FiniteSet(c, B, C, S, hc)
